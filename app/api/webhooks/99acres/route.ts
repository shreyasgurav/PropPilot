...
/**
 * Direct lead webhook from 99acres (or a manual integration / Zapier).
...
export async function POST(request: NextRequest) {
  try {
    ...
    const parsed = parseLeadWebhook(payload, LeadSource.NINETYNINEACRES);
    ...
    console.error("99acres webhook error:", err);
